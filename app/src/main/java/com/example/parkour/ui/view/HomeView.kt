                ...
                selectedCompetition?.let {
                    Column(
                        ...
                        Row(
                            ...
                            Button(onClick = { navController.navigate("updateCompetition/${it.id}") }) {
                                Text("Modifier")
                            }
                            Button(onClick = { viewModel.deleteCompetition(it.id) }) {
                                Text("Supprimer")
                            }
                            Button(onClick = { navController.navigate("arbitration/${it.id}/1") }) {
                                Text("Arbitrer")
                            }
                        }
                    }
